...
import { sensitiveContentKinds } from './fixtures/data-aid/sensitive-content.ts'

const driver = fileURLToPath(new URL('./fixtures/data-aid/driver.ts', import.meta.url))
const config = fileURLToPath(new URL('./fixtures/data-aid/cordis.yml', import.meta.url))
const expected = fileURLToPath(new URL('./expected/data-aid/data-query-transcript.expected.jsonl', import.meta.url))

...
| [data-query.md](data-query.md) | controlled semantic-query request/context separation, branded turn ids, five-field safe results, provider selection, `DataQueryError` |

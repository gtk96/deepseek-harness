...
flowchart TD
  ...
  subgraph group_identity["packages/identity"]
    ...
    pkg_authenticated_principal["authenticated-principal"]
    pkg_authenticated_principal_data_aid["authenticated-principal-data-aid"]
    pkg_data_query["data-query"]
    pkg_data_query_dic_be["data-query-dic-be"]
  end
  ...
  pkg_authenticated_principal --> pkg_brand
  pkg_authenticated_principal --> pkg_invariants
  ...
  pkg_data_query --> pkg_authenticated_principal
  pkg_data_query --> pkg_brand
  pkg_data_query --> pkg_invariants
  pkg_data_query --> pkg_llm
  pkg_lsp --> pkg_brand
  ...
  pkg_data_query_dic_be --> pkg_data_query
  pkg_data_query_dic_be --> pkg_invariants
  pkg_data_query_dic_be --> pkg_launch_environment
  pkg_data_query_dic_be --> pkg_timeout
  ...
  pkg_authenticated_principal_data_aid --> pkg_agent
  pkg_authenticated_principal_data_aid --> pkg_agent_default_model
  pkg_authenticated_principal_data_aid --> pkg_agent_presets
  pkg_authenticated_principal_data_aid --> pkg_authenticated_principal
  pkg_authenticated_principal_data_aid --> pkg_client_connection
  pkg_authenticated_principal_data_aid --> pkg_data_query
  pkg_authenticated_principal_data_aid --> pkg_host_webserver
  pkg_authenticated_principal_data_aid --> pkg_invariants
  pkg_authenticated_principal_data_aid --> pkg_llm
  pkg_authenticated_principal_data_aid --> pkg_mcp_client
  pkg_authenticated_principal_data_aid --> pkg_tools
...
| [`data-aid`](../packages/bundle/data-aid) | `bundle` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`authenticated-principal`](../packages/identity/authenticated-principal) | `identity` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`data-query`](../packages/identity/data-query) | `identity` | [`authenticated-principal`](../packages/identity/authenticated-principal), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm) |
...
| [`data-query-dic-be`](../packages/identity/data-query-dic-be) | `identity` | [`data-query`](../packages/identity/data-query), [`invariants`](../packages/runtime-diagnostics/invariants), [`launch-environment`](../packages/util/launch-environment), [`timeout`](../packages/util/timeout) |
...
| [`authenticated-principal-data-aid`](../packages/identity/authenticated-principal-data-aid) | `identity` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`agent-presets`](../packages/preset/agent-presets), [`authenticated-principal`](../packages/identity/authenticated-principal), [`client-connection`](../packages/client/connection), [`data-query`](../packages/identity/data-query), [`host-webserver`](../packages/host/webserver), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`mcp-client`](../packages/mcp/mcp-client), [`tools`](../packages/core/tools) |

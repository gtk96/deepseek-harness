...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/identity/authenticated-principal': { kind: 'none', reason: 'Request-local identity and permission state is never rendered into model context.' },
  'packages/identity/data-query': { kind: 'indirect', reason: 'The provider runtime delegates model schemas and result rendering to its Consumer.' },
  'packages/identity/data-query-dic-be': { kind: 'indirect', reason: 'The HTTP Provider delegates model schemas and result rendering to the Data Aid Consumer.' },
  ...
  'packages/bundle/data-aid': { kind: 'indirect', reason: 'The bundle delegates its fixed persona and sole tool schema to the shipped data-aid preset.' },

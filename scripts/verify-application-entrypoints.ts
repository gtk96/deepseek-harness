...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ['apps/cli/config/data-aid-test/dic-be-fixture.mjs', 'local-only data-aid broker smoke fixture'],
  ['apps/cli/src/bin.ts', 'supported dsh application launcher'],
  ['apps/cli/tests/profiles/headless/tests/fixtures/data-aid/driver.ts', 'test-only snapshot subprocess driver'],

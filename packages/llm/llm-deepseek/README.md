...
- Object tool schemas without a `required` member serialize as `required: []`; the value is equivalent in JSON Schema and avoids gateways that turn an omitted member into invalid `null`.
